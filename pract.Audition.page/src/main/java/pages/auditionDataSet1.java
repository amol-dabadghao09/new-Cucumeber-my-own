...
public class auditionDataSet1 extends utilityClassAudi {
	...
	public auditionDataSet1(WebDriver driver)
	{
		this.driver = driver;
	...
	{
		System.out.println(utilityClassAudi.getExcelData("auditionForm", 2, 0));
		teamName.sendKeys(utilityClassAudi.getExcelData("auditionForm", 2, 0));
	}
	
	public void giveSchoolName() throws EncryptedDocumentException, IOException
	{
		school.sendKeys(utilityClassAudi.getExcelData("auditionForm", 2, 1));
	}
	
	public void selectCategory()
	{
		Select sel = new Select(dropDownCat);
		sel.selectByVisibleText("Music Show");
	}
	
	public void giveActLength() throws EncryptedDocumentException, IOException
	{
		actLength.sendKeys(utilityClassAudi.getExcelData("auditionForm", 2, 3));
	}
	
	public void giveSongName() throws EncryptedDocumentException, IOException
	{
		songSelect.sendKeys(utilityClassAudi.getExcelData("auditionForm", 2, 4));
	}
	
	public void giveContactInfo() throws EncryptedDocumentException, IOException
	{
		fname.sendKeys(utilityClassAudi.getExcelData("auditionForm", 2, 5));
		lname.sendKeys(utilityClassAudi.getExcelData("auditionForm", 2, 6));
		phNum.sendKeys(utilityClassAudi.getExcelData("auditionForm", 2, 7));
		emailId.sendKeys(utilityClassAudi.getExcelData("auditionForm", 2, 8));
	}
	...
	public void auditionDateAndTime() throws EncryptedDocumentException, IOException
	{
		...
		audiDate.sendKeys(utilityClassAudi.getExcelData("auditionForm", 2, 9));
		audiTime.click();
		audiTime.sendKeys(Keys.CONTROL + "a");
		audiTime.sendKeys(utilityClassAudi.getExcelData("auditionForm", 2, 10));
	}
	
	public void giveComment() throws EncryptedDocumentException, IOException
	{
		comment.sendKeys(utilityClassAudi.getExcelData("auditionForm", 2, 11));
	}
